...
public class FilosofoThread1 extends Thread {
    private final static int FILOSOFO_ESQUERDA = 0; // Id do filosofo que esta a sua esquerda
    private final static int FILOSOFO_DIREITA = 2; // Id do filosofo que esta a sua direita

    private int id = 1; // Id do filosofo
