    ...
    *************************************************************** */
    ...
    public void run() {
        while(true) {
            ...
            Buffer.changeConsumiuImage(2, 1); // Modifica o image view da exclacao para opacidade 100%
            try { sleep(1000); } 
            catch (InterruptedException e) { e.printStackTrace(); }
            Buffer.changeConsumiuImage(2, 2); // Modifica o image view da exclacao para opacidade 20%
