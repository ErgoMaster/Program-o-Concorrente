...
public class FilosofoThread4 extends Thread {
    private final static int FILOSOFO_ESQUERDA = 3; // Id do filosofo que esta a sua esquerda
    private final static int FILOSOFO_DIREITA = 0; // Id do filosofo que esta a sua direita

    private int id = 4; // Id do filosofo
