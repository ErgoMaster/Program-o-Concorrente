...
public class FilosofoThread2 extends Thread { 
    private final static int FILOSOFO_ESQUERDA = 1; // Id do filosofo que esta a sua esquerda
    private final static int FILOSOFO_DIREITA = 3; // Id do filosofo que esta a sua direita

    private int id = 2; // Id do filosofo
