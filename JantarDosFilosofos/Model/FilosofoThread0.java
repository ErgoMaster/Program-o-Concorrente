...
public class FilosofoThread0 extends Thread {
    private final static int FILOSOFO_ESQUERDA = 4; // Id do filosofo que esta a sua esquerda
    private final static int FILOSOFO_DIREITA = 1; // Id do filosofo que esta a sua direita

    private int id = 0; // Id do filosofo
